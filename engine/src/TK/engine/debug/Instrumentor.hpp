#ifndef TUNKS_INSTRUMENTOR_HPP
#define TUNKS_INSTRUMENTOR_HPP
...
#else
#define TK_PROFILE_BEGIN_SESSION(name,filepath)
#define TK_PROFILE_END_SESSION()
#define TK_PROFILE_SCOPE(name)
